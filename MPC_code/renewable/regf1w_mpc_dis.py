"""
Grid-forming renewable energy model with droop control and supplemantery distributed MPC. Edited wind constraints.
"""
...
class REGF1W_MPC_DISData(ModelData):
    """
    REGF1W_MPC_DIS model data.
    """
    ...
    def __init__(self):
        ...
        self.bus2 = IdxParam(model='Bus 2',
                            info="Measurement 2 bus id",
                            mandatory=True,
                            )
...
class REGF1W_MPC_DISModel(Model):
    """
...
class REGF1W_MPC_DIS(REGF1W_MPC_DISData, REGF1W_MPC_DISModel, REGF1W_MPC_DISPrimary,
    ...
    def __init__(self, system, config):
        REGF1W_MPC_DISData.__init__(self)

        REGF1W_MPC_DISModel.__init__(self, system, config)
        REGF1W_MPC_DISPrimary.__init__(self)
